...
public class AnnotatorConfigConverter implements JsonDeserializer<AnnotatorConfig> {
  ...
  public AnnotatorConfig deserialize(
    ...
    switch (kind) {
      case MOCK:
        MockAnnotatorConfig mockCfg =
            gson.fromJson(obj.toString(), MockAnnotatorConfig.class);
        return mockCfg;
      case VULNERABILITY:
        VulnerabilityAnnotatorConfig vulnCfg =
            gson.fromJson(obj, VulnerabilityAnnotatorConfig.class);
        return vulnCfg;
      case SBOM:
        SbomAnnotatorConfig sbomCfg = gson.fromJson(obj, SbomAnnotatorConfig.class);
        return sbomCfg;
      default:
