...
class TpmAnnotator extends AbstractAnnotator implements Annotator {
  ...
  public Annotation execute(PropertyBag ctx, byte[] data) throws AnnotatorException {
    ...
    try {
      ...
      // Checks whether the TPM driver is accessible through the kernel resource manager, and
      // if that
      // failes, checks if the TPM driver can be accessed directly
      isSatisfied =
          checkTpmExists(this.tpmKernelManagedPath) || checkTpmExists(this.directTpmPath);
