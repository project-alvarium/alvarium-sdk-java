...
public class ChecksumAnnotator extends AbstractAnnotator implements Annotator {
  ...
  public Annotation execute(PropertyBag ctx, byte[] data) throws AnnotatorException {
    ...
    final ChecksumAnnotatorProps props =
        ctx.getProperty(AnnotationType.CHECKSUM.name(), ChecksumAnnotatorProps.class);
  ...
  private final void initHashProvider(HashType hashType) throws AnnotatorException {
    try {
      ...
      throw new AnnotatorException(
          "Hashing algorithm not found, could not hash data or validate checksum", e);
    } catch (Exception e) {
  ...
  private final String hashFile(String filePath) throws AnnotatorException {
    try {
      ...
      throw new AnnotatorException("Failed to hash artifact, could not validate checksum", e);
    }
